...
public class frmBuscarDetalle_Ventas extends javax.swing.JDialog {
  ...
  //--------------------------------------------------------------
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addComponent(txtId_Venta, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(77, 77, 77))))
    ...
    private void tblVendedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblVendedoresMouseClicked
        if (evt.getClickCount()==2) {
            ...
            txtId_Venta.setText(tblVendedores.getValueAt(fila, 1).toString());
            this.dispose();
        }
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String condicion="";
        try {
            if (!txtId_Venta.getText().equals("")) {
                condicion="ID_VENTA LIKE '%"+txtId_Venta.getText()+"%'";
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBuscarDetalle_Ventas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                frmBuscarDetalle_Ventas dialog = new frmBuscarDetalle_Ventas(new javax.swing.JFrame(), true);
