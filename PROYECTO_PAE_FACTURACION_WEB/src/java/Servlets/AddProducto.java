    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        */
        ...
        try {
            ...
            entidad.setId(Integer.parseInt(request.getParameter("txtIdproducto")));
            ...
            entidad.setDescripcion(new String(request.getParameter("txtdescripcion").getBytes("ISO-8859-1"), "UTF-8"));
           ...
           entidad.setPrecio(Float.parseFloat(request.getParameter("txtprecio")));
           entidad.setStock(Integer.parseInt(request.getParameter("txtStock")));
